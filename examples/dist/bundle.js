...
},{"./Select":"react-select","./utils/stripDiacritics":28,"react":undefined}],26:[function(require,module,exports){
'use strict';
...
var Select = _react2['default'].createClass({
	...
	componentDidUpdate: function componentDidUpdate(prevProps, prevState) {
		...
		if (this._menuRef && this.refs.focused && this.state.isOpen && !this.hasScrolledToOption) {
			...
			var menuNode = _reactDom2['default'].findDOMNode(this._menuRef);
		...
		if (this._scrollToFocusedOptionOnUpdate && this.refs.focused && this._menuRef) {
			...
			var menuDOM = _reactDom2['default'].findDOMNode(this._menuRef);
	...
	renderOuter: function renderOuter(options, valueArray, focusedOption) {
		...
		return _react2['default'].createElement(
			...
			_react2['default'].createElement(
				'div',
				{ ref: function (node) {
						_this8._menuContainerRef = node;
					}, className: 'Select-menu-outer', style: this.props.menuContainerStyle },
				_react2['default'].createElement(
					'div',
					{ ref: function (node) {
							_this8._menuRef = node;
...
},{"./Async":25,"./Option":26,"./Value":27,"./utils/stripDiacritics":28,"classnames":undefined,"react":undefined,"react-dom":undefined,"react-input-autosize":undefined,"react-portal":13}]},{},[]);
